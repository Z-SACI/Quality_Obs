    ...
    <div class="container-fluid">
        <div class="row mt-5">
            <div class="col-sm-4 offset-sm-2  mt-5">
              <h1>PV d'Essais d'Entreprise </h1>
            </div>
            <div class="col-4  mt-5" style="float:right"><b>
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Ajouter un PV d'Essais d'Entreprise</li>
                    </ol>
                </b>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="card col-8 text-center p-0 mt-3 mb-3">
                <div class="card-body">
                    <form method="POST" action="{{route('SavePvEssais')}}" class="msform">
                        @csrf
                        <!-- progressbar -->
                        <ul id="progressbar">
                            ...
                            <div id="msform" class="msform">
                                ...
                                <div id="hidediv2" style="display:none;">
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            <div class="form-group row mr-2 ml-2">
                                                <label for="pe_date" class="col-sm-2 col-form-label">Référence du PV</label>
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" placeholder="Introduisez le Code" id="" name="pe_ref_pv">
                                                </div>
                                                <label for="pe_date" class="col-sm-2 col-form-label">Date PV</label>
                                                <div class="col-sm-4">
                                                    <input type="date" class="form-control" placeholder="Introduisez le Code" id="" name="pe_date_pv">
                                                </div>
                                            </div>
                                            <div class="form-group row mr-2 ml-2">
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            <div class="form-group row mr-2 ml-2">
                                                <label for="inputEmail" class="col-sm-2 col-form-label">E/C</label>
                                                <div class="col-sm-4">

                ...
                <tbody>
                    ...
                    <tr>
                        <div>
                            ...
                            <td>
                            <div class="row">
                                <div class="row"  id="buttons{{$row->elem_id}}" >
                                    <a href="admin/ouvrages/elements{{$row->elem_id}}/prelevements" class="btn btn-outline-primary btn-sm" data-toggle="modal"><span>Data CTC</span></a>		
                                    <a href="admin/ouvrages/elements{{$row->elem_id}}/prelevementsEntreprise" class="btn btn-outline-secondary btn-sm" data-toggle="modal" ><span>Data Entreprise</span></a>		
                                </div>
                            </div>  
                            </td>
                        </div>

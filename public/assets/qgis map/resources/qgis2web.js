...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-1.483096, 32.225068, 8.520082, 37.800148], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([-1.483096, 32.225068, 8.520082, 37.800148], map.getSize());
